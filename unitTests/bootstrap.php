<?php
/**
 * $Id: bootstrap.php 2892 2011-08-14 15:11:50Z mark@lange.demon.co.uk $
 *
 * @copyright   Copyright (C) 2018 Mark Baker. All rights reserved.
 * @package     QudTrees
 * @subpackage  QudTrees Unit Tests
 * @author      Mark Baker
 */
